...
The information presented in this Stock Market Trading Workshop is intended for educational purposes only and does not constitute financial advice or a solicitation to buy or sell any financial instruments. The information is provided “as is” without warranty of any kind, express or implied, including but not limited to the implied warranties of merchantability, fitness for a particular purpose, or non-infringement.
...
You agree to use the information provided in this workshop responsibly and ethically.`}
                    ...
                    <AnimateOnScroll animationClasses="animate-fade-in-up" className="animation-delay-400">
                        <p className="whitespace-pre-line text-red-500 text-lg">
{`All The Rights Of This Prototypes Are Reserved  And the information and images shown here is a prototype and Non Copyrighted. Remember, this Website Is For Sale.                                                                                         For More Details,                                             Contact : +91 8600070638                                        Email : kavirajverma1976@gmail.com`}
                        </p>
                    </AnimateOnScroll>
                </div>
            </div>
