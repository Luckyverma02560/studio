    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 p-4" style={transformStyle}>
            <h1 className="font-display text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-[3px] uppercase opacity-0 animate-heading-in heading-light-sweep">
              About Us
            </h1>
